myApp.controller('ProjectMinderController', ['$scope', 'CRUD', 'Mailto', function($scope, CRUD, Mailto) {
	...
	$scope.copyrightAlert = {
		type: 'warning',
		msg: 'This system is for IFN701 demonstration only,NOT FOR BUSINESS PURPOSE. All the QUT-LIKE styles are referenced from QUT website.'
	}

	$scope.sendMail = function(mailto, subject) {
		var link = "mailto:" + mailto + "?subject=" + escape(subject) + "&body=" + escape(document.getElementById('emailcontent').value);
		console.log(link);
