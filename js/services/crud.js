myApp.factory('CRUD', ['$wilddogArray', 'WILDDOG_URL', function($wilddogArray, WILDDOG_URL) {

  var ref = new Wilddog(WILDDOG_URL + "projects");
  return {
    ...
    setToArray: function(ref) {
      var projectItems = $wilddogArray(ref);
      return projectItems;
    },
